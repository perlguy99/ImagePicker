...
//    //    }
//    
//    //    self.frontCamera = AVCaptureDevice.DiscoverySession.init(deviceTypes: [AVCaptureDevice.DeviceType.builtInWideAngleCamera], mediaType: AVMediaType.video, position: .front).devices[0]
//    
//    AVCaptureDevice.DiscoverySession.init(deviceTypes: [AVCaptureDevice.DeviceType.builtInWideAngleCamera], mediaType: AVMediaType.video, position: .unspecified)
//      .devices
//      .forEach {
//        switch $0.position {
//        case .back:
...
//    }
//    
//    //    self.backCamera = AVCaptureDevice.DiscoverySession.init(deviceTypes: [AVCaptureDevice.DeviceType.builtInWideAngleCamera], mediaType: AVMediaType.video, position: .back).devices[0]
//    
//    
//    // Output
//    stillImageOutput = AVCapturePhotoOutput() // AVCaptureStillImageOutput()
//    
